...
namespace Assets.Scripts.Menus
{
    public class ObjectSelectingParametersMenu : ParametersMenu
    {
        ...
        private readonly ObjectSelectingMenuIcon changeSelectionColorIcon = new ObjectSelectingMenuIcon(GameObject.Find("Change Selection Color"), GameManager.Instance.ActionsData.Selecting, GameManager.Instance.ActionsData.ObjectSelecting.SetStateChangeColor);
