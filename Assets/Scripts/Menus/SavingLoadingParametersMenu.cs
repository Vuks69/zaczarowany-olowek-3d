...
namespace Assets.Scripts.Menus
{
    public class SavingLoadingParametersMenu : ParametersMenu
    {
        ...
        private readonly LoadingMenuIcon loadingIcon1 = new LoadingMenuIcon(GameObject.Find("Loading 1"), GameManager.Instance.ActionsData.Selecting, 1);
        private readonly LoadingMenuIcon loadingIcon2 = new LoadingMenuIcon(GameObject.Find("Loading 2"), GameManager.Instance.ActionsData.Selecting, 2);
        private readonly LoadingMenuIcon loadingIcon3 = new LoadingMenuIcon(GameObject.Find("Loading 3"), GameManager.Instance.ActionsData.Selecting, 3);
